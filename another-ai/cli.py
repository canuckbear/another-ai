...
different words of command supported by another-ai.
...
import textwrap
import logging
from another-ai.model import Key
from another-ai.model import Configuration
from another-ai import run_testsuite
from another-ai import check_testsuite
from another-ai import check_library
from another-ai import release
...
Available commands are   . ''' + Key.CHECK_LIBRARY.value + '''       Check the test library consistency
...
#                           help="If this flag is activated, another-ai will stop at the first\n"
...
#                          help="If this flag is activated, another-ai will output only failed\n"
...
#self.parser.add_argument(Key.OPT_SHOW_HINTS.value,
 ...
 #                         help="If this flag is activated, another-ai will display hints when\n"
